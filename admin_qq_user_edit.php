...
?>
    ...
    <form action="config/update_user.php" method="post">
    	<p>
    	<label>Id：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
        <input type="text" name="Id" class="kf_form" value="<?php echo $row['Id'];?>" readonly="readonly"/>
        </p>
    	<p>
    	<label>用 户 名：&nbsp;</label>
        <input type="text" name="user_name" class="kf_form" value="<?php echo $row['user_name'];?>"/>
        </p>
    	<p>
        <label>重设密码：</label>
  		<input type="text" name="user_pwd" class="kf_form" value="<?php echo $row['user_pwd'];?>">
        </p>
    	<p>
    	<label>平台名称：</label>
  		<input type="text" name="user_plat" class="kf_form" value="<?php echo $row['user_plat'];?>">
        </p>
    	<p>
    	<label>平台等级：</label>
    	...
    	<p>
    	<label>电子邮箱：</label>
        <input type="text" name="user_mail" class="kf_form" value="<?php echo $row['user_mail'];?>" />
        </p>
    	<p>
    	<label>平台网站：</label>
        <input type="text" name="user_plat_website" class="kf_form" value="<?php echo $row['user_plat_website'];?>" />
        </p>
    	<p>
